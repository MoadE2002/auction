...
import { 
  ...
  Home,
  Report,
} from '@mui/icons-material'; // Import relevant Material UI icons
...
const links = [
  { route: "/auctions", label: "Auctions", icon: <Gavel /> },
  { route: "/settings", label: "Settings", icon: <Settings /> },
  { route: "/myBids", label: "My Bids", icon: <LocalGroceryStore /> },
      ...
      <Sheet>
        <SheetTrigger asChild>
          <div className='cursor-pointer sm:hidden'>
            <Image
              src="/assets/profile.png" // Profile image path
              width={36}
              height={36}
              alt='profile'
